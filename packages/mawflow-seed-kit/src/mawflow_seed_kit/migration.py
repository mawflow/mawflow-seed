...
def plan_migration(root: Path | str, *, profile: str = "web-api") -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    for source_ref in [".maw/modules.yaml", ".maw/app-runtime.yaml", ".maw/project-doctor.yaml", ".maw/template-source.yaml", ".maw/upgrade-policy.yaml", ".maw/agent-entry.yaml", "AI_START_HERE.md"]:
